...
class WxPayApi
{
     ...
     * appid、mch_id、spbill_create_ip、nonce_str不需要填入
     ...
     * 支付结果通用通知
     * @param $callback
     * 直接回调函数使用方法: notify(your_function);
     * 回调类成员函数方法:notify(array($this, your_function));
 ...
 * Class WxPayDataBase
 * @package App\Libraries\Vendor\WxPay
 */
class WxPayDataBase
{
 ...
 *
 */
class WxPayAppInitiate extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
